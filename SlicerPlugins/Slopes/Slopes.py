...
# Slopes
#
class Slopes(ScriptedLoadableModule):
...
def registerSampleData():
    ...
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        ...
        thumbnailFileName=os.path.join(iconsPath, 'Slopes1.png'),
        # Download URL and target file name
        uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/998cb522173839c78657f4bc0ea907cea09fd04e44601f17c82ea27927937b95",
        fileNames='Slopes1.nrrd',
    ...
    SampleData.SampleDataLogic.registerCustomSampleDataSource(
        ...
        category='Slopes',
        sampleName='Slopes2',
        thumbnailFileName=os.path.join(iconsPath, 'Slopes2.png'),
        # Download URL and target file name
        uris="https://github.com/Slicer/SlicerTestingData/releases/download/SHA256/1a64f3f422eb3d1c9b093d1a18da354b13bcf307907c66317e2463ee530b7a97",
        fileNames='Slopes2.nrrd',
...
class SlopesWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setup(self):
        ...
        uiWidget = slicer.util.loadUI(self.resourcePath('UI/Slopes.ui'))
...
class SlopesLogic(ScriptedLoadableModuleLogic):
    ...
    def run(self, geometries, rasRightDirection, folderName):
        ...
        for inputGeometry, vertebra in zip(geometries, self.spine):
            ...
            lastPoint = firstPoint + distance * vertebra.body.regressions[Endplate.UPPER]
...
class SlopesTest(ScriptedLoadableModuleTest):
    """
    ...
    def test_Slopes1(self):
        ...
        import SampleData
        registerSampleData()
        inputVolume = SampleData.downloadSample('Slopes1')
